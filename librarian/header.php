                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="book_details_with_students.php"><i class="fa fa-bar-chart-o"></i> Books With All Info <span
                                    class="fa fa-chevron-down"></span></a>

                                </li>
                                <li><a href="send_notification.php"><i class="fa fa-envelope"></i> Send Message <span
                                    class="fa fa-chevron-down"></span></a>
