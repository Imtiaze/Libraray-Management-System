        ...
        <section class="login_content" style="margin-top: -40px;">
            <form name="form1" action="" method="post">
                ...
                <div class="col-lg-12  col-lg-push-3">
                    <input class="btn btn-default submit " type="submit" name="submit1" value="Register" style="background-color:#1ABB9C; color:white;">
                </div>
...
<!--
    if(isset($_POST["submit1"])){
        ...
        $request = filter_input_array(INPUT_POST,$deafultFilter);
